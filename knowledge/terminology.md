...
Verified sprint-era distinction: constructor_results.points includes sprint points in the supplied snapshot. All 180 constructor/race rows with sprint records in 2021–2024 matched the sum of main-race results.points plus sprint_results.points. Therefore main-race-only or “excluding sprints” points MUST be summed from results, not constructor_results. Do not assume a table's name establishes its metric semantics.
