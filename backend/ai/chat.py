...
class ChatService:
    ...
    def answer(self, request):
        ...
        if route.intent in {"prediction", "explanation"}:
            ...
            leader = prediction["predictions"][0]
            return {
                "intent": route.intent,
                "answer": f"For the selected race, {leader['driver_name']} has the highest model podium probability: {leader['probability']:.1%}. Compare all drivers and their model contributions below.",
