...
The verified dev application runs at [the AWS Lightsail HTTPS endpoint](https://f1-strategist-demo.ys85rp5g9ncdj.eu-north-1.cs.amazonlightsail.com/), backed by private encrypted PostgreSQL. Lightsail deployment 13 is `RUNNING` / `ACTIVE` on immutable application image `91382f8b4895ff53cdcfeb66c0e7aa4689d7b531` with ECR digest `sha256:be81cc251318219892e77d0f381a46de14e0c4d509474f334b8e5aae0e738d8e`. GitHub Actions run [`34521407938`](https://github.com/rayyanpasha89/F1/actions/runs/34521407938) and CodeBuild `f1-race-strategist-dev:291889a4-bf82-4c42-b77a-a73a2b4a6a8e` passed for that application source. The final append-only public verifier and cloud evidence are in `reports/model_accountability_aws_release_final.json` and `reports/model_accountability_cloud_verification.json`. CloudWatch stream `lightsail/20260910T213030991935Z` contains the bounded runtime snapshot; readback found prediction, review and chat completion events while configured credentials, provider settings, database URLs, SQL and question text were absent.
